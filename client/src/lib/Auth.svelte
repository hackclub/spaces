    ...
    <div class="auth-form-content">
      ...
      {#if mode === 'login' || mode === 'signup'}
        <form on:submit|preventDefault={sendVerificationCode}>
          ...
          <button class="hackclub-button club-member-button" type="button" on:click={() => dispatch('clubmember')}>
            <svg class="hackclub-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
